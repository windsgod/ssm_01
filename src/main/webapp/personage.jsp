        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-4 mb-30">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">Personage</li>
                </ol>
                <!-- breadcrumb end -->
            </div>
        </div>
...
<div class="contact-us-page pt-70 pb-40">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 mb-30">
                <!-- contact form -->
                <form class="form-style-1" method="post" enctype="multipart/form-data" action="contact.php">
                    <h4 class="mb-6">个人中心</h4>
                    <p>请填写下面的表格，我们会尽快与您联系。</p>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>姓名<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" required value="${login_user.name}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>详细问题描述<span class="text-danger">*</span></label>
                        <textarea class="form-control" rows="3" required></textarea>
                    </div>
                    <button type="submit" class="btn-style-1">提交</button>
                </form>
                <!-- contact form end -->
            </div>
