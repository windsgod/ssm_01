...
<head>
    ...
    <script type="text/javascript">
        function Check(){
            ...
            var userpasswords = document.getElementById("userpasswords").value;
            if (username == "" || username.value == null ||userpassword == "" || userpassword.value == null ||useremail == "" || useremail.value == null ||userpasswords==""||userpasswords==null) {
                alert("请输入内容");
            }
        }
    </script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <!-- register box -->
                <div class="login-box">
                    <form class="form-style-1 shadow p-30" action="register" accept-charset="UTF-8" method="post">
                        <p>创建您的账户，以便我们为您提供更好的服务！</p>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Name" name="name" id="username" required="required">
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="Email" name="email" id="useremail" required="required">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Password" name="password" id="userpassword" required="required">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Confirm Password" name="passwords" id="userpasswords" required="required">
                        </div>
                        <button type="submit" class="btn-style-1 w-100" onclick="Check()">注册</button>
                    </form>
                </div>
                <!-- register box end -->
            </div>
