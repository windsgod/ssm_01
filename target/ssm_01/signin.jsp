    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <!-- login box -->
                <div class="login-box">
                    <form class="form-style-1 shadow p-30" method="post" action="login">
                        <p>请在下面输入您的邮箱和密码，用来登录我们的网站，以便我们能为您提供更好的服务。</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label font-size-14" for="exampleCheck1">记住密码</label>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="forgot-password text-right"> <a href="" class="text-danger">忘记密码！</a> </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn-style-1 w-100">登录</button>
                        </div>
                        <p class="mb-0">还没有注册？<a href="register.jsp">去注册!</a></p>
                    </form>
                </div>
                <!-- login box end -->
            </div>
